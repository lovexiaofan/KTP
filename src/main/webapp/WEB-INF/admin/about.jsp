...
<div class="bg_b">
    <div class="pst">
        您当前的位置：<a style="cursor: hand">关于我们</a>> <a style="cursor: hand">成员介绍</a>
    </div>
</div>
<div class="scd clearfix">
    ...
    <div class="scd_r">
        <div class="r_top"><span>成员介绍</span></div>
        <div class="scd_m clearfix">
            <img src="../statics/upload/pic5.jpg" width="295" height="290" alt="" style="float:left; margin-right:15px; margin-top:15px;">
            <p style="font-size:16px; padding-top:15px; font-weight:bold; margin-bottom:10px;">上海市上大晓凡有限公司</p>
            <p>王晓凡 13122547</p>
        </div>
    </div>
</div>
