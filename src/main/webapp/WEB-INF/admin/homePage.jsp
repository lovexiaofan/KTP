...
<div class="bg_a">
    <div class="t_news">
        <div class="t_news">
            <b>热点新闻：</b>
            <ul class="news_li">
                <li><a>最好用的学生学习管理工具</a></li>
                <li><a>最方便的教师课程管理工具</a></li>
                <li><a>最直接的师生交流问答工具</a></li>
                <li><a>最优秀的课程作业发布工具</a></li>
            </ul>
            <ul class="swap"></ul>
        </div>
    </div>
...
<ul class="f_nav clearfix">
    ...
    <li class="dz">
        ...
        <p class="email">企业邮箱：<a href="mailto:www.sales@satlead.com">shengchan@xuexipai.com</a></p>
...
<div class="f_bg">
    <div class="foot clearfix">
        <div class="f_l">
            <span>友情链接：</span>
            <a href="javascript:void(0)" onclick=u()>课堂派</a>
        </div>
        <div class="f_r">
...
<script type="text/javascript">
    ...
    function u()
    {
        window.open("http://www.ketangpai.com");
    }
</script>
</html>
