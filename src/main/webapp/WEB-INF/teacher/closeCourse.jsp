    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="teacherCloseCourse"><i class="fa fa-qrcode"></i> 关课</a>
                </li>
                <li>
                ...
                <div class="row">
                    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                        ...
                        <div class="table-responsive">
                            <form method="get" accept-charset="utf-8" action="teacherCloseCourseSave">
                                <div class="mb-3">
                                    <span>课 程 号:</span>
                                    <label>
                                ...
                                <br>
                                <button type="submit" class="btn btn-primary btn-lg btn-block">关课</button>
                            </form>
                        </div>
                    </main>
                </div>
